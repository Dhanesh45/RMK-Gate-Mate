            ...
            <div style={{width:"50%",height:"100%",padding:"2% 0%"}}>
                ...
                <div style={{padding:"3% 5% 5% 5%"}}>
                    ...
                    <div style={{textAlign:"center"}}>
                      <button style={{padding:"2% 30%",borderRadius:"30px",fontSize:"20px",fontWeight:"600",color:"white",backgroundColor:"rgba(17,73,71,17)"}} onClick={()=>navigate("/StudentDashboard")}>
                        LOGIN
                      </button>
                    </div>
                </div>
